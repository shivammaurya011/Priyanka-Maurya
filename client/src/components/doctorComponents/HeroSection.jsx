    ...
    <section className="">
      <div className="grid max-w-screen-xl px-4 mx-auto lg:gap-8 xl:gap-0 lg:grid-cols-12">
        ...
        <div className="mr-auto place-self-center lg:col-span-7">
          ...
          <Link to={'/doctor/contact'} className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-white border bg-blue-900 border-white rounded-full hover:bg-blue-800 focus:ring-4 focus:ring-gray-100">
            Contact Now
          </Link> 
        </div>
      </div>
